...
describe("notificationsSlice", () => {
    it("should return the initial state", () => {
        expect(notificationsSlice(undefined, { type: 'unknown' })).toEqual(initialState);
    });
    ...
    it("should handle markNotificationAsRead", () => {
        ...
        expect(notificationsSlice(stateWithNotifications, action)).toEqual(expectedState);
    });
    ...
    it("should handle hideDrawer", () => {
        ...
        expect(notificationsSlice(initialState, action)).toEqual(stateWithDrawerClosed);
    });
});
